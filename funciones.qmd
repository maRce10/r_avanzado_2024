...
Permiten a los usuarios ingresar objetos en la función. Los valores proporcionados en los argumentos son utilizados en el cuerpo de la funcion para hacer los cálculos necesarios. 
...
5.1 Cree una funcion que calcule el promedio, la desviación estándar y el error estándar de un vector numérico. Estos valores deben ser devueltos como una lista con nombres.

5.2 Permita a los usuarios ignorar los `NAs` (similar al argumento `na.rm` en `mean()`, pista: añada un argumento lógico)

5.3 Haga que la función además produzca un histograma del vector numérico proporcionado por el usuario

5.4 Haga que la función permita al usuario defini el color para las barras del histograma
...
5.7 Modifique la función para que también cree una linea vertical indicando el promedio del vector numérico proporcionado por el usuario
